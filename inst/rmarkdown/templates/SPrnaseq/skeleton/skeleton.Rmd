...
<!--
Rscript -e "rmarkdown::render('SPrnaseq.Rmd', c('BiocStyle::html_document'), clean=F); knitr::knit('SPrnaseq.Rmd', tangle=TRUE)"; Rscript -e "rmarkdown::render('SPrnaseq.Rmd', c('BiocStyle::pdf_document'))"
-->
...
while the `SPrnaseq.Rmd` script and the `targets` file are expected to be 
